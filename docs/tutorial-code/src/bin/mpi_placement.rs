//! MPI placement collectives: `broadcast`, `scatter`, and `gather`.
//!
//! Build and run:
//!
//! ```sh
...
fn main() {
    println!("HATAORI_TUTORIAL_SKIP: mpi_placement needs --features mpi or --features rsmpi-rt");
}
